...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    models: "Models",
    model_control_description:
      "Global model connections, catalog and stage assignments. Changes apply only after validation and activation.",
    validate_models: "Validate draft",
    activate_models: "Activate",
    model_connections: "Connections",
    no_model_connections: "No model connections",
    model_catalog: "Model catalog",
    no_models: "No models",
    catalog_only: "Catalog only",
    stage_assignments: "Stage assignments",
    stage_assignments_description:
      "One global map. Thinking and token limits are resolved by the gateway.",
  ...
  ru: {
    ...
    ready_ok: "готово",
    ready_degraded: "частично готово",
    ...
    models: "Модели",
    model_control_description:
      "Глобальные подключения, каталог моделей и назначения по этапам. Изменения применяются только после проверки и активации.",
    validate_models: "Проверить черновик",
    activate_models: "Активировать",
    model_connections: "Подключения",
    no_model_connections: "Подключений моделей нет",
    model_catalog: "Каталог моделей",
    no_models: "Моделей нет",
    catalog_only: "Только каталог",
    stage_assignments: "Назначения по этапам",
    stage_assignments_description:
      "Одна глобальная схема. Thinking и лимиты токенов задаются через Gateway.",
    active_revision: "Активная версия",
    not_configured: "не настроено",
    test_connection: "Проверить подключение",
    credentials_configured: "ключ настроен",
    credentials_missing: "ключ не настроен",
    enabled: "включено",
    disabled: "отключено",
    connection_name: "Имя подключения",
    driver: "Драйвер",
    base_url: "Адрес endpoint",
    add_connection: "Добавить подключение",
    model_alias: "Псевдоним модели",
    provider_model_id: "ID модели у провайдера",
    operation: "Операция",
